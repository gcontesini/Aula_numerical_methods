program LU_decomposition
  ...
  double precision :: norm_1_dp , norm_inf_dp , norm_2_dp , norm_inv_1_dp 
  double precision :: norm_inv_inf_dp , norm_inv_2_dp , k_a_1_dp , k_inf_dp
  size_int = 5
...
subroutine identity_matrix(i_mtx,size_int)
  implicit none
  integer , intent(in) :: size_int
